...
{
    public class YonetimKuruluViewComponent : ViewComponent
    {
        public IApiCall _apiCall;
        public YonetimKuruluViewComponent(IApiCall apiCall)
        {
            _apiCall = apiCall;
        }
        private string webServiceUrl = "https://eoda.adaso.org.tr/AdasoWebYonetimKurulu?KullaniciAdi=Administrator&Sifre=**00**&bos=0";
