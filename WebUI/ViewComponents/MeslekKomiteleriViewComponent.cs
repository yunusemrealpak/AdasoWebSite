...
{
    public class MeslekKomiteleriViewComponent : ViewComponent
    {
        public IApiCall _apiCall;
        public MeslekKomiteleriViewComponent(IApiCall apiCall)
        {
            _apiCall = apiCall;
        }
        private string webServiceUrl = "https://eoda.adaso.org.tr/AdasoWebMeslekKomiteleri?KullaniciAdi=Administrator&Sifre=**00**&bos=0";
